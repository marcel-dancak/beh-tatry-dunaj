...
!function(){"use strict";function t(t,e,n){function o(){var o=e.defer();return n.get(a).then(function(e){var n=e.data.sections;if(e.data.start){var i=moment(e.data.start,"HH:mm");i.isValid()&&(t.startTime=i)}angular.merge(n,window.DATA.sections_static),o.resolve(n)},function(){o.reject()}),o.promise}function i(t){return 1===t?"1 minútu":t>1&&t<5?t+" minúty":t+" minút"}var a="https://api.myjson.com/bins/3w2k5",r={};window.DATA.runners.forEach(function(t){r[t.id]=t}),t.runners=r,t.loadState=function(){var e=localStorage.getItem("startTime");e=e?moment(e,"HH:mm"):moment().minute(0).second(0),t.startTime=e;var n=localStorage.getItem("pendingOperations");n=n?JSON.parse(n):[],t.pendingOperations=n},t.saveState=function(){localStorage.setItem("startTime",t.startTime.format("HH:mm")),localStorage.setItem("pendingOperations",JSON.stringify(t.pendingOperations))},t.loadState(),t.updateSectionsList=function(e){t.runningSectionId=-1;var n=0,o={time:t.startTime.format("HH:mm:ss")};console.log("updateSectionsList: "+e.length),e.forEach(function(e){var a=e.k*(e.length/10)*e.runner.time_on_10km;if(e.expectedDuration=a.toFixed(2),e.time){var r=moment(o.time,"HH:mm:ss"),s=moment(e.time,"HH:mm:ss"),c=s.diff(r,"seconds");c<0&&(s.add(1,"day"),c=s.diff(r,"seconds")),e.duration=moment.duration(c,"seconds").format("HH:mm:ss");var m=60*e.expectedDuration,l=c-m;e.comparison=(l>=0?"+":"-")+moment.duration(Math.abs(l),"seconds").format("mm:ss",{trim:!1}),n++}else if(!e.time&&o.time){t.runningSectionId=e.id;var r=moment(o.time,"HH:mm:ss"),u=moment().diff(r,"minutes");u<0&&(r.subtract(1,"day"),u=moment().diff(r,"minutes")),t.runningSectionTime=i(u),e.expectedStart=moment(o.time,"HH:mm:ss")}else o.expectedStart&&(e.expectedStart=o.expectedStart.clone().add(o.expectedDuration,"minute"));o=e});var a=e[e.length-1];a.time?t.finishTime=moment(a.time,"HH:mm:ss"):(t.finishTime=null,t.expectedFinish=a.expectedStart.clone().add(a.expectedDuration,"minute")),t.filter=Math.max(-(e.length-n+1),-e.length),t.filter=Math.min(t.filter,-3)},t.showNetworkErrorNotification=function(t){setTimeout(function(){MyApp.fw7.app.addNotification({message:"Chyba pripojenia",button:{text:"Skúsiť znova",color:"yellow",close:!0},additionalClass:"network-error",onClose:function(){MyApp.fw7.app.pullToRefreshTrigger(t)}})},400)},t.fetchData=function(){console.log("fetchData");var i=e.defer();return o().then(function(e){if(t.pendingOperations){console.log("Merge and Upload new sections"),console.log(t.pendingOperations),t.saveState(),console.log(JSON.stringify(e)),localStorage.setItem("sections-backup",JSON.stringify(e));var o=!1;for(var r in t.pendingOperations){var s=e[r-1],c=t.pendingOperations[r];for(var m in c)console.log("checking: "+s[m]+" vs: "+c[m].old),s[m]===c[m].old?s[m]=c[m].new:o=!0}o&&MyApp.fw7.app.addNotification({message:"Nastala kolízia s inými zmenami, niektore údaje neboli uložené.",button:{text:"Zatvoriť",color:"yellow",close:!0}});var l=JSON.stringify(e,function(t,e){if(""===t||"id"===t||"runner"===t||"time"===t||Number.isInteger(parseInt(t)))return e}),u={sections:JSON.parse(l),start:t.startTime.format("HH:mm")};n.put(a,u).then(function(){t.pendingOperations={},t.saveState()},function(){t.showNetworkErrorNotification(".index.pull-to-refresh-content")})}e.forEach(function(e){e.runner=t.runners[e.runner]}),t.updateSectionsList(e),t.sections=e,i.resolve()},function(){if(!t.sections){var e=localStorage.getItem("sections-backup");if(e){JSON.parse(e)}}t.showNetworkErrorNotification(".index.pull-to-refresh-content"),i.reject()}),i.promise},t.detail={section:null,runner:null,finish_time:""},t.detailPage=function(e){console.log(e),t.detail.section=e,t.detail.runner=angular.copy(e.runner),t.detail.finish_time=e.time||"",history.pushState({page:"detail"},"Detail"),MyApp.fw7.app.mainView.router.loadPage({pageName:"detail"})},t.back=function(t){history.back()},history.pushState({page:"index"},"Index"),window.onpopstate=function(t){console.log(t.state),t.state&&t.state.page?MyApp.fw7.app.mainView.router.back({pageName:t.state.page}):history.back()}}t.$inject=["$scope","$q","$http"],MyApp.angular.controller("AppController",t).directive("onLongPress",["$timeout",function(t){return{restrict:"A",link:function(e,n,o){n.bind("touchstart",function(n){e.longPress=!0,t(function(){e.longPress&&e.$apply(function(){e.$eval(o.onLongPress)})},600)}),n.bind("touchend",function(t){e.longPress=!1,o.onTouchEnd&&e.$apply(function(){e.$eval(o.onTouchEnd)})})}}}])}();
...
MyApp.angular.controller("MessagesController",["$scope","$q","$timeout","$http","InitService",function(e,t,a,n,s){"use strict";function o(){MyApp.fw7.app.pullToRefreshTrigger(".messages-content.pull-to-refresh-content")}function r(){var e=t.defer();return n.get(i).then(function(t){var a=t.data.reverse(),n=localStorage.getItem("name")||"";a.forEach(function(e,t){e.type=e.name===n?"sent":"received"}),m.removeMessages(".messages-date"),m.removeMessages(".message"),m.addMessages(a),e.resolve()}),e.promise}var p,m,i="https://api.myjson.com/bins/1hte1";e.promptUserName=function(){var n=t.defer();return MyApp.fw7.app.prompt("","Zadaj meno",function(t){localStorage.setItem("name",t),a(function(){e.userName=t}),n.resolve(),o()},o),n.promise},e.sendMessage=function(){var e=p.value().trim();e&&n.get(i).then(function(t){var a=t.data,s=localStorage.getItem("name")||"",o={text:e,name:s,day:moment().format("MMM DD"),time:moment().format("HH:mm")};a.push(o),n.put(i,a).then(function(){m.addMessage(o),p.value("")})})},s.addEventListener("ready",function(){function t(t){console.log("Messages page entered"),p=MyApp.fw7.app.messagebar(".messagebar",{maxHeight:200}),m=MyApp.fw7.app.messages(".messages",{autoLayout:!0,newMessagesFirst:!0});var s=Dom7(".messages-content.pull-to-refresh-content");s.on("refresh",function(t){MyApp.fw7.app.closeNotification(".notification-item.network-error"),a(function(){var t=r();t.catch(function(){e.showNetworkErrorNotification(".messages-content.pull-to-refresh-content")}),t.finally(function(){MyApp.fw7.app.pullToRefreshDone()})})}),n()}function n(t){e.userName=localStorage.getItem("name"),e.userName?o():e.promptUserName()}MyApp.fw7.app.onPageInit("messagesPage",t),MyApp.fw7.app.onPageReinit("messagesPage",n)})}]);
...
window.DATA={},window.DATA.runners=[{id:1,car:1,name:"Katka",time_on_10km:65,tel:"+420605030867"},{id:2,car:1,name:"Jirka",time_on_10km:65,tel:"+420731108383"},{id:3,car:2,name:"Mato",time_on_10km:50,tel:"+421904303201"},{id:4,car:2,name:"Vlado",time_on_10km:46,tel:"+421948049495"},{id:5,car:2,name:"Peto",time_on_10km:60,tel:"+421918464008"},{id:6,car:2,name:"Marcel",time_on_10km:50,tel:"+421948334748"},{id:7,car:3,name:"Palo T.",time_on_10km:48,tel:"+421905649405"},{id:8,car:3,name:"Palo B.",time_on_10km:48,tel:"+421950528252"},{id:9,car:3,name:"Tibor",time_on_10km:52,tel:"+421910186982"},{id:10,car:3,name:"Marek",time_on_10km:52,tel:"+421908396228"},{id:11,car:1,name:"Miroslav",time_on_10km:60,tel:"+420733646511"},{id:12,car:1,name:"Darina",time_on_10km:54,tel:"+420602455600"}],window.DATA.sections_static=[{id:1,length:9.8,elevation_up:100,elevation_down:450,k:.91334,from:"Demänovská dolina"},{id:2,length:10.4,elevation_up:120,elevation_down:230,k:.9846,from:"Pavčina lehota"},{id:3,length:11.9,elevation_up:320,elevation_down:250,k:1.058,from:"Ľubeľa"},{id:4,length:9.5,elevation_up:530,elevation_down:90,k:1.1684,from:"Ľupčianska dolina"},{id:5,length:11,elevation_up:30,elevation_down:530,k:.90455,from:"Železnô"},{id:6,length:9.8,elevation_up:230,elevation_down:110,k:1.0398,from:"Liptovská Osada"},{id:7,length:9.4,elevation_up:500,elevation_down:550,k:1.084,from:"Vyšná Revúca"},{id:8,length:9.5,elevation_up:430,elevation_down:500,k:1.16623,from:"Hotel Šturec"},{id:9,length:7.8,elevation_up:120,elevation_down:250,k:.936,from:"Baláže"},{id:10,length:9.6,elevation_up:70,elevation_down:150,k:1.01663,from:"Selce"},{id:11,length:9.6,elevation_up:80,elevation_down:100,k:.98542,from:"Banská Bystrica"},{id:12,length:8,elevation_up:100,elevation_down:100,k:.9963,from:"Sielnica"},{id:13,length:11,elevation_up:100,elevation_down:140,k:1,from:"Stráže"},{id:14,length:11.6,elevation_up:150,elevation_down:150,k:1.056,from:"Hronská Dúbrava"},{id:15,length:10,elevation_up:70,elevation_down:100,k:.989,from:"Žiar nad Hronom"},{id:16,length:8.4,elevation_up:120,elevation_down:130,k:.94643,from:"Hliník nad Hronom"},{id:17,length:7,elevation_up:140,elevation_down:150,k:1.0443,from:"Žarnovica"},{id:18,length:8.6,elevation_up:100,elevation_down:120,k:.9535,from:"Voznica"},{id:19,length:11,elevation_up:130,elevation_down:180,k:1.03826,from:"Brehy"},{id:20,length:11.7,elevation_up:170,elevation_down:150,k:1.0837,from:"Hronský Beňadik"},{id:21,length:7.4,elevation_up:40,elevation_down:60,k:.9891,from:"Nemčiňany"},{id:22,length:8.7,elevation_up:20,elevation_down:50,k:.9874,from:"Nevidzany"},{id:23,length:9.3,elevation_up:20,elevation_down:20,k:1,from:"Vráble"},{id:24,length:9.6,elevation_up:70,elevation_down:80,k:1.00733,from:"Kmetovo"},{id:25,length:8.7,elevation_up:20,elevation_down:20,k:1.0633,from:"Komjatice"},{id:26,length:10.6,elevation_up:10,elevation_down:20,k:1.0151,from:"Rastislavice"},{id:27,length:11.2,elevation_up:20,elevation_down:10,k:1.0768,from:"Selice"},{id:28,length:11.8,elevation_up:10,elevation_down:20,k:1.0584,from:"Šaľa"},{id:29,length:10.7,elevation_up:20,elevation_down:20,k:1.11215,from:"Horné Saliby"},{id:30,length:7.4,elevation_up:20,elevation_down:20,k:1.10135,from:"Čierna Voda"},{id:31,length:11.4,elevation_up:20,elevation_down:20,k:1.05446,from:"Potôňské Lúky"},{id:32,length:7.2,elevation_up:20,elevation_down:20,k:1.0972,from:"Veľký Lég"},{id:33,length:7.5,elevation_up:10,elevation_down:10,k:1.0826,from:"Čukárska Paka"},{id:34,length:7.4,elevation_up:20,elevation_down:20,k:1.092,from:"Šamorín"},{id:35,length:11.3,elevation_up:10,elevation_down:0,k:1.0824,from:"Hamuliakovo"},{id:36,length:8.9,elevation_up:50,elevation_down:50,k:1.099,from:"Jamaica  (BA hrádza)"}];